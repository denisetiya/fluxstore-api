...
__export(dist_exports, {
  ...
  download: () => import_chunk_ITLELC6Y.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_ITLELC6Y.getBinaryName,
  getCacheDir: () => import_chunk_5T2KHPZI.getCacheDir,
  getProxyAgent: () => import_chunk_RJCNBAHR.getProxyAgent,
  getVersion: () => import_chunk_ITLELC6Y.getVersion,
  maybeCopyToTmp: () => import_chunk_ITLELC6Y.maybeCopyToTmp,
  overwriteFile: () => import_chunk_5T2KHPZI.overwriteFile,
  plusX: () => import_chunk_ITLELC6Y.plusX,
  vercelPkgPathRegex: () => import_chunk_ITLELC6Y.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_ITLELC6Y = require("./chunk-ITLELC6Y.js");
